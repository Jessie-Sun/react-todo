...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _localDb = __webpack_require__(163);

	var _localDb2 = _interopRequireDefault(_localDb);

	var _TodoHeaderJs = __webpack_require__(164);

	var _TodoHeaderJs2 = _interopRequireDefault(_TodoHeaderJs);

	var _TodoMainJs = __webpack_require__(165);

	var _TodoMainJs2 = _interopRequireDefault(_TodoMainJs);

	var _TodoFooterJs = __webpack_require__(167);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _TodoItemJs = __webpack_require__(166);
		...
		_createClass(TodoFooter, [{
			...
			value: function render() {
				return _react2["default"].createElement(
					...
					_react2["default"].createElement("input", { type: "checkbox", className: "fl", checked: this.props.isAllChecked, onChange: this.handlerSelectAll.bind(this) }),
					_react2["default"].createElement(
						"span",
						{ className: "fl" },
						"已完成",
					...
					_react2["default"].createElement(
						"button",
						{ className: "fr", onClick: this.handlerDeleteDone.bind(this) },
						"清除已完成的任务"
					)
				);
			}
